...
silent only
cd ~/Documents/project/mounter/var/www/html/test
...
badd +102 class/db-class.php
badd +82 class/getdividedwordfromdom-class.php
badd +35 class/selectwords-class.php
badd +41 index.php
